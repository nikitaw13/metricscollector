...
func parseFlags() {
	...
	flag.IntVar(&flagStoreInterval, "i", 15, "интервал времени в секундах, по истечении которого текущие показания сервера сохраняются на диск. Значение 0 делает запись синхронной ")
